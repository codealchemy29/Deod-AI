...
import { Mail, Sparkles, CheckCircle2, Users, TrendingUp, Gift, Bell, Zap, ArrowRight, Shield, BookOpen, Lightbulb, Rocket, Loader2, } from "lucide-react";
var benefits = [
    {
        icon: TrendingUp,
...
var formSchema = insertNewsletterSubscriptionSchema.extend({
...
export default function Newsletter() {
    ...
    var subscribeMutation = useMutation({
        mutationFn: function (data) { return __awaiter(_this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, apiRequest("POST", "/api/newsletter/subscribe", { email: data.email })];
                    case 1:
                        response = _a.sent();
        ...
        onError: function (error) {
            ...
            toast({
                ...
                description: ((_a = error.message) === null || _a === void 0 ? void 0 : _a.includes("already subscribed"))
        ...
        <div className="relative max-w-4xl mx-auto px-4 md:px-6 lg:px-8 text-center">
          ...
          <Card className="max-w-lg mx-auto border-border/50 bg-card/80 backdrop-blur-sm" data-testid="card-subscribe-form">
            ...
            return (<FormItem className="flex-1">
                          <FormControl>
                            <Input type="email" placeholder="Enter your email address" className="focus-visible:ring-[#1e3a8a]" {...field} data-testid="input-newsletter-email"/>
                          </FormControl>
                          <FormMessage />
                        </FormItem>);
        }}/>
                    <Button type="submit" className="bg-[#1e3a8a] hover:bg-[#1e3a8a]/90 text-white border-0" disabled={subscribeMutation.isPending} data-testid="button-subscribe">
                  ...
                  <FormField control={form.control} name="agreedToTerms" render={function (_a) {
            var field = _a.field;
            return (<FormItem className="flex flex-row items-start space-x-3 space-y-0 text-left">
                        <FormControl>
                          <Checkbox checked={field.value} onCheckedChange={field.onChange} className="data-[state=checked]:bg-[#1e3a8a] data-[state=checked]:border-[#1e3a8a]" data-testid="checkbox-terms"/>
                        </FormControl>
      ...
      <section className="py-16 md:py-24 bg-card/30">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map(function (benefit, index) { return (<Card key={index} className="text-center border-border/50 bg-card/50 backdrop-blur-sm group hover:border-[#1e3a8a]/50 transition-colors" data-testid={"card-newsletter-benefit-".concat(index)}>
                <CardContent className="p-6">
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {pastIssues.map(function (issue, index) { return (<Card key={index} className="hover-elevate border-border/50 bg-card/50 backdrop-blur-sm group hover:border-[#1e3a8a]/30" data-testid={"card-past-issue-".concat(index)}>
                <CardContent className="p-6">
      ...
      <section className="py-16 md:py-24 bg-card border-y border-border">
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto">
            <Input type="email" placeholder="Enter your email" className="flex-1 focus-visible:ring-[#1e3a8a]" data-testid="input-footer-newsletter"/>
