          ...
          <div className="flex gap-2 mt-4 overflow-x-auto pb-2 scrollbar-hide">
            {categories.map((cat) => (
              <Button
                ...
                className={`flex-shrink-0 ${selectedCategory === cat.id ? "bg-[#1e3a8a] hover:bg-[#1e3a8a]/90" : "hover:border-[#1e3a8a] hover:text-[#1e3a8a]"}`}
            ...
            {false ? (
              ...
              filteredProducts.map((product, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`h-32 bg-gradient-to-br ${getCategoryColor(product.category)} opacity-10 relative group-hover:opacity-20 transition-opacity`}>
                    ...
                    <CardContent className="p-5">
                      ...
                      <div className="flex items-center justify-between gap-4 pt-4 border-t border-border/50">
                        ...
                        <Button className="bg-[#1e3a8a] hover:bg-[#1e3a8a]/90 text-white border-0" data-testid={`button-buy-${index}`}>
