    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-16 md:py-20">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-10 right-10 w-72 h-72 bg-pink-500/20 rounded-full blur-3xl" />
        </div>
        
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <Badge variant="secondary" className="mb-4" data-testid="badge-marketplace-hero">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                <SelectTrigger className="w-[160px]" data-testid="select-marketplace-category">
          ...
          <div className="flex gap-2 mt-4 overflow-x-auto pb-2 scrollbar-hide">
            {categories.map((cat) => (
              <Button
                ...
                data-testid={`button-marketplace-category-${cat.id}`}
              >
            ...
            {isLoading ? (
              ...
              filteredProducts.map((product, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`h-32 bg-gradient-to-br ${getCategoryColor(product.category)} opacity-20 relative`}>
                      <div className="absolute inset-0 flex items-center justify-center">
                        <CategoryIcon className="h-12 w-12 text-foreground/20" />
                      </div>
                    </div>
                    <CardContent className="p-5">
                      <div className="flex items-start justify-between gap-2 mb-3">
                      ...
                      <div className="flex items-center justify-between gap-4 pt-4 border-t border-border/50">
                        ...
                        <Button className="bg-gradient-to-r from-purple-600 to-pink-500 text-white border-0" data-testid={`button-buy-${index}`}>
      ...
      <section className="py-16 md:py-24 bg-card border-y border-border">
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 text-center">
          <Badge variant="secondary" className="mb-4" data-testid="badge-seller-cta">
          ...
          <Button size="lg" className="bg-gradient-to-r from-purple-600 to-pink-500 text-white border-0" data-testid="button-become-seller">
            Start Selling Today
          </Button>
        </div>
      </section>
