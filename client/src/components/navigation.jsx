...
var navItems = [
    ...
    { href: "/create", label: "Know your Agent", icon: Wrench },
    { href: "/submit", label: "Use your Agent", icon: Upload },
                        ...
                        {navItems.map(function (item) {
                            return (
                                <Link key={item.href} href={item.href}>
                                    <button
                                        className={"px-3 py-2 text-sm font-medium transition-colors rounded-md ".concat(
                                            location === item.href
                                                ? "bg-[#1e3a8a]/10 text-[#1e3a8a]"
                                                : "text-muted-foreground hover:text-[#1e3a8a] hover:bg-[#1e3a8a]/5",
                                        )}
                                        data-testid={"link-".concat(
                                            item.label
                                                .toLowerCase()
                                                .replace(" ", "-"),
                                        )}
                        ...
                        {user ? (
                            <div className="flex items-center gap-1 md:gap-3">
                                ...
                                <Button
                                    ...
                                    onClick={logout}
                                    title="Logout"
                                    className="hidden md:flex text-red-500 hover:bg-red-500/10"
                                >
                                ...
                                return (
                                    <Link key={item.href} href={item.href}>
                                        <Button
                                            ...
                                            className={"w-full justify-start gap-2 ".concat(
                                                location === item.href
                                                    ? "bg-[#1e3a8a]/10 text-[#1e3a8a]"
                                            ...
                                            data-testid={"mobile-link-".concat(
                                                item.label
                                                    .toLowerCase()
                                                    .replace(" ", "-"),
                                            )}
