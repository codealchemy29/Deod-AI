...
>
  ...
  <img
    ...
    alt="Logo"
    className="h-20 w-[130px] md:h-18 md:w-[180px] object-contain dark:hidden"
  />

  {/* Dark Theme Footer Logo (Hidden by default, shown in Dark Mode) */}
  <img
    src="/logo_black.png" // Replace with your dark theme footer logo path
    alt="Logo"
    className="hidden h-20 w-[130px] md:h-18 md:w-[180px] object-contain dark:block"
  />
</Link>
